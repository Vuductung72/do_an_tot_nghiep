        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Thêm mới khen thưởng</h4>
                </div>
                <div class="card-body">
                    <div class="form-validation">
                        <form class="needs-validation" enctype="multipart/form-data" action="{{ route('ad.achievements_store') }}" novalidate method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-xl-12">
                                    {{-- nhân viên --}}
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control @error('reason') is-invalid @enderror" name="reason" id="reason"  placeholder="Nhập lý do khen thưởng..." value="{{ old('reason') }}">
                                            @error('reason')
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control input-money @error('money') is-invalid @enderror" name="money" id="money" placeholder="Nhập số tiền thưởng..." value="{{ old('money') }}"  required>
                                            @error('money')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
